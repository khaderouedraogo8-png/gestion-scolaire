...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Programmes', path: '/etablissement/programmes' },
      { label: 'Périodes', path: '/etablissement/periodes' },
      { label: 'Niveaux', path: '/etablissement/niveaux' },
      { label: 'Classes', path: '/etablissement/classes' },
      { label: 'Trimestres (legacy)', path: '/config/trimestres' },
