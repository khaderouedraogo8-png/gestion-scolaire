...
const menuItems = [
  ...
  { label: 'Notes & résultats', path: '/parent/notes', icon: 'notes', roles: ['parent'] },
  { label: 'Évolution', path: '/parent/evolution', icon: 'dashboard', roles: ['parent'] },
  { label: 'Bulletins', path: '/notes/bulletins', icon: 'notes', roles: ['parent'] },
  { label: 'Absences', path: '/absences', icon: 'absences', roles: ['parent'] },
  { label: 'Notifications', path: '/parent/notifications', icon: 'notifications', roles: ['parent'] },
  {
